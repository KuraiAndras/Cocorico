...
{
    public sealed class GetAllOrderForCustomerRequestHandler : RequestHandlerBase<GetAllOrderForCustomerQuery, ICollection<CustomerViewOrderDto>>
    {
        public GetAllOrderForCustomerRequestHandler(
            IMediator mediator,
            IMapper mapper,
