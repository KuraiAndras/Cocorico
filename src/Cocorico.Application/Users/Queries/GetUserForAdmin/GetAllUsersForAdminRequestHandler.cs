...
{
    public sealed class GetAllUsersForAdminRequestHandler : RequestHandlerBase<GetAllUsersForAdminQuery, ICollection<UserForAdminPage>>
    {
        private readonly UserManager<CocoricoUser> _userManager;

        public GetAllUsersForAdminRequestHandler(
            IMediator mediator,
            IMapper mapper,
